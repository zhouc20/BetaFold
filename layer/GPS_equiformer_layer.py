...
class GPS_equiformer_Layer(nn.Module):
    """Local MPNN + full graph attention x-former layer, plus an equiformer layer
    """
    ...
    def __init__(self, dim_h,
                 ...
                 equiformer=False, irreps_in='5x0e', radius=5.0, num_basis=128, max_num_neighbors=256):
        super().__init__()
        ...
        if equiformer:
            ...
            irreps_in=irreps_in,
            irreps_node_embedding='128x0e+32x0o+32x1e+32x1o+16x2e+16x2o', num_layers=1,
            ...
            norm_layer='layer',
            alpha_drop=0.2, proj_drop=0.0, out_drop=dropout, drop_path_rate=0.0,
            scale=None, max_num_neighbors=max_num_neighbors)
        else:
            self.equiformer = None
    ...
    def forward(self, batch):
        ...
        if self.equiformer is not None:
            h_3d_equiformer = self.equiformer(f_in=None, pos=batch.pos, batch=batch.batch, atom_embedding=h)
            h_out_list.append(h_3d_equiformer)
